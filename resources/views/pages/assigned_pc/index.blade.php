<x-layouts.its_layout>
    ...
    <div x-data="{form: false, fmodal: ''}">
        {{-- <button @click="form = true" class="mb-5 px-3 py-2 rounded-md bg-black text-white">Add Setup</button> --}}
        <div>
            <x-tables.assigned_pc_table :pcs="$PcAssigned" :departments="$departments" :campuses="$campuses" />
        </div>
