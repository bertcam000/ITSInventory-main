...
<section>
    ...
    <form wire:submit="updateProfileInformation" class="mt-6 space-y-6">
        <div>
            ...
            <div>
                <input type="text" wire:model="name" id="name" name="name" class="w-full rounded border-gray-300" required autofocus autocomplete="name" placeholder="ex. OptiPlex 5080">
            </div>
        ...
        <div>
            ...
            <div>
                <input type="text" wire:model="username" id="username" name="username" type="username" class="w-full rounded border-gray-300" required autocomplete="username" placeholder="ex. OptiPlex 5080">
            </div>
