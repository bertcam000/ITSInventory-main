...
new class extends Component {
    ...
    public function submit()
    {
        ...
        redirect('APlocation')->with('success', 'Location added successfully!');
    }
...
<div @click.away="fmodal === ''" class="max-w-md mx-auto mt-10 bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
    <h2 class="text-xl font-semibold text-gray-800 mb-2">Add New AP Location</h2>
    <p class="text-sm text-gray-500 mb-6">Enter the location name to add it to the system.</p>
    <form class="space-y-4" wire:submit.prevent="submit" @click.away="fmodal = ''">
        <div>
            <label class="block text-sm text-gray-600 mb-1" for="name">Location Name</label>
            <input
                wire:model="name"
                type="text"
                id="name"
                name="name"
                placeholder="e.g. MV Lobby"
